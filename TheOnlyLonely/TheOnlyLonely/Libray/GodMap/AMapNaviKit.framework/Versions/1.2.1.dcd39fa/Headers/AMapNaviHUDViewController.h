...
/*!
 @brief HUD界面返回按钮点击时的回调函数
 */
- (void)AMapNaviHUDViewControllerBackButtonClicked:(AMapNaviHUDViewController *)naviHUDViewController __attribute__ ((deprecated("use - (void)naviHUDViewControllerBackButtonClicked:(AMapNaviHUDViewController *)naviHUDViewController instead")));
